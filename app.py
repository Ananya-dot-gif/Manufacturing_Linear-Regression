...
st.write("""
### Project: Data Science Capstone Project — Manufacturing Equipment Output Prediction
Predict hourly **Parts Per Hour (Output)** using machine operating parameters such as temperature, pressure, cycle time, and more.
""")
...
**Goal:** Predict and optimize machine efficiency
""")

# Input Section
st.header("🔧 Enter Machine Operating Parameters")
...
def user_input_features():
    ...
    # Convert categorical values to numeric like label encoding
...
if st.button("🚀 Predict Output"):
    ...
    st.info("Use this prediction to optimize machine settings and improve production efficiency.")

# Footer
st.markdown("---")
st.markdown("**Developed by:** Data Science Capstone Team | © 2025")
